    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_photo2', models.ImageField(blank=True, upload_to='cars/%Y/%m/%d')),
                ('car_photo3', models.ImageField(blank=True, upload_to='cars/%Y/%m/%d')),
                ('car_photo4', models.ImageField(blank=True, upload_to='cars/%Y/%m/%d')),
